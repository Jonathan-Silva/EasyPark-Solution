 ...
 * @author Suporte-01
 */
public class View_ConFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form View_ConFuncionario
     */
    public View_ConFuncionario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        groupConFuncionario = new javax.swing.ButtonGroup();
        ...
        groupConFuncionario.add(rbtNome);
        ...
        txtFiltro.setText("Informe o código do Funcionario");
        ...
        groupConFuncionario.add(rbtCPF);
        ...
        if (dtgConFuncionario.getColumnModel().getColumnCount() > 0) {
            dtgConFuncionario.getColumnModel().getColumn(0).setMinWidth(80);
            dtgConFuncionario.getColumnModel().getColumn(0).setPreferredWidth(70);
            dtgConFuncionario.getColumnModel().getColumn(0).setMaxWidth(90);
        }

        groupConFuncionario.add(rbtCod);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_ConFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_ConFuncionario().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.ButtonGroup groupConFuncionario;
    ...
    private void MudarTexto() {
        ...
        {
            txtFiltro.setText("Informe o nome do Funcionario");
        }
        else
        {
            txtFiltro.setText("Informe o CPF do Funcionario");
        }
    }
    ...
    private void Popular(){
        List<Ctrl_Funcionario> ListaDeFuncionario = new ArrayList<Ctrl_Funcionario>();
        if (rbtCod.isSelected()==true) {
            ListaDeFuncionario = Model.Model_Funcionario.Busca(txtFiltro.getText(),0);
        }
        if (rbtNome.isSelected()==true) {
            ListaDeFuncionario = Model.Model_Funcionario.Busca(txtFiltro.getText(),1);
        }
        if (rbtCPF.isSelected()==true) {
            ListaDeFuncionario = Model.Model_Funcionario.Busca(txtFiltro.getText(),2);
        }

        DefaultTableModel model = (DefaultTableModel) dtgConFuncionario.getModel();
        for (int i = 0; i < ListaDeFuncionario.size(); i++) {
            Object[] linha = {ListaDeFuncionario.get(i).getIdFuncionario(), ListaDeFuncionario.get(i).getNome(), ListaDeFuncionario.get(i).getCpf()};
            model.addRow(linha);
        }
        dtgConFuncionario.setModel(model);
    }
